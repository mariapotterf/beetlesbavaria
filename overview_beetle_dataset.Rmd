...
# xy_sf_elev_4326 <- st_read(paste(out_path, "r_beetlesbavaria/outSpatial/traps_with_elevation.gpkg", sep = '/'))
# 
# !!!
...
As we have several collection dates per year/traps (1-27, median value of days between two collection is 6), I have calculated how often the three categories occurs from total records times per trap. For map display, I have chosen only **over** and **no_fit** categories, where I have chosen the higher share per record.
...
```{r ips_cv_hist, include = T, warning = F, echo = F, fig.height=3,fig.width = 5, fig.cap = "Distribution of Coefficient of Variation (CV) counts by year. Red dot represent yearly median, red lines yearsly IQR. Dashed grey line represent median over years. "}
