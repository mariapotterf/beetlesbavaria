...
Q1: Variation of beetle population dynamics over time and space: 
 ...
 - does beetle population increase earlier in the year? = swarming
 - do beetles aggregate faster? eg. earlier in a year reach some threshold? (1000 beetles)
...
- Calculate total sum of beetles per trap/year.
- Calculate beetles emergence: the max different number of beetles between consecutive dates 
- Calculate beetle aggregation : DOY of the beetles reaching 1000 beetles/trap.
...
- DOY of 1000 beetles aggregated per  trap
- output of LISA?
...
```{r p_lisa_sub, fig.width = 6, fig.height = 6, echo = F, fig.cap="Local Indicators of Spatial Assotiation. No signoficat values are not shown."}
